...
class TrainVal:
    ...
    def df(self):
        ...
        print("New train set length and first n rows:", len(train_set2), train_set2.head(), "Val set length and first n rows:", len(val_set), val_set.head(), "Train set label distribution:", train_set2['label'].value_counts(), "Test set label distribution:", val_set['label'].value_counts(), sep="\n")
