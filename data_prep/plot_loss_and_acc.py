...
def plot_loss_and_acc(
    ...
    df_metrics[["train_recall", "val_recall"]].plot(
        grid=True, legend=True, xlabel="Epoch", ylabel="Recall"
    )
    plt.ylim(recall_ylim)
    
    df_metrics[["train_precision", "val_precision"]].plot(
        grid=True, legend=True, xlabel="Epoch", ylabel="Precision"
    )
    plt.ylim(precision_ylim)
    
    df_metrics[["train_f1score", "val_f1score"]].plot(
        grid=True, legend=True, xlabel="Epoch", ylabel="F1 Score"
    )
    plt.ylim(f1score_ylim)
